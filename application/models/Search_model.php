...
class Search_model extends Webcoder_Model {
    ...
    public function with_company() {
        $this->db->join( 'company_user_rel', 'users.id = company_user_rel.user_id', 'left' );
        $this->db->join( 'companies', 'companies.id = company_user_rel.company_id', 'left' );
