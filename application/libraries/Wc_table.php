        ...
        if ($this->rows) {
            foreach ($this->rows as $key => $row) {
                ...
                if ($this->action) {
                    ...
                    if(isset($this->action['sender']) && $this->action['sender'] === TRUE)
                    {
                        $formatted_rows[$key]['action']     .= '<li><a href="'.site_url_multi($this->url.'/sender/').$row->id.'" class="sender" data-popup="tooltip" title="'.translate('sender', true).'"><i class="icon-upload"></i></a></li>';
                    }
                        if(isset($this->action['login_cms']) && $this->action['login_cms'] === TRUE)
                    {
                        $formatted_rows[$key]['action']     .= '<li><a href="'.site_url_multi($this->url.'/login_cms/').$row->id.'" class="sender" data-popup="tooltip" title="'.translate('login', true).'"><i class="icon-user"></i></a></li>';
                    }
