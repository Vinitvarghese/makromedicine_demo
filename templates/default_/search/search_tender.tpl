...
<div class="wrap margin-top-100 col-md-12">
    <div class="container-fuild">
        <div class="row">
            ...
            <div class="col-md-12 search-table-wrp2">
                <form class="searchTable2" action="{base_url('home/search_table2')}" method="post">
                  <div class="col-md-12 no-padding tables-data">
                      <table class="table responsive table-striped no-padding display table-search-not" id="example2" >
                          <thead>
                              <tr>
                                  <th class="one"></th>
                                  <th class="two">
                                  ...
                                  <th class="three" data-priority="1">
                                    <input type="text" name="tender_name" class="form-control tender_name" placeholder="Tender Name">
                                     <span class="mobile-responsive">Tender Name</span>
                                  </th>
                                  <th class="four">
                                  ...
                                  <th class="seven">
                                    <select class="form-control selectpicker show-menu-arrow select_continent" multiple data-live-search="true" multiple data-actions-box="true" data-selected-text-format="count > 0" title="Continent"></select>
                                     <span class="mobile-responsive">Continent</span>
                                  </th>
                                  <th class="eight">
                                    <select class="form-control selectpicker show-menu-arrow select_trade_term" multiple data-live-search="true" data-actions-box="true" data-selected-text-format="count > 0" title="Trade term"></select>
                                     <span class="mobile-responsive">Trade term</span>
                                  </th>
    ...
    if (w >= 768) {
        if (y > top_offset1) {
         ...
         if ((y > top_offset33 && !$(".header .bottom-menu.advanced-menu").hasClass('is-shown')) || (y > top_offset3 && $(".header .bottom-menu.advanced-menu").hasClass('is-shown'))) {
          console.log(y+' 1');
            $('.searchTable2 #example2 thead').addClass("is-fixed");
            $('.searchTable2 #example2 tbody').css('border-top','70px solid #ddd');
           if($(".header .bottom-menu.advanced-menu").css('display') != 'none') {
             $('.searchTable2 #example2 thead').css('top','70px');
              $(".header .bottom-menu.advanced-menu").css('top','70px');
            }
        } else {
           console.log(y+' 2');
            $('.searchTable2 #example2 thead').removeClass("is-fixed");
            $('.searchTable2 #example2 tbody').css('border-top','none');
            $('.searchTable2 #example2 thead').css('top','35px');
