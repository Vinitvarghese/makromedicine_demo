                ...
                <div class="container" id="add-product">
                    ...
                    <div class="col-md-12 no-padding add-product collapse {if isset($message)} in {/if}" id="collapseExample">
                        <div class="col-md-12 no-padding panel-add">
                            <form class="" role="form" method="POST" action="{site_url_multi('product/add')}"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group add-c-count" >
                                                            ...
                                                            <input type="text" class="form-control mylos" placeholder="" name="shelf_life">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group add-c-count" >
                                                            ...
                                                            <textarea class="form-control mylos" placeholder="" nname="description" rows="4"></textarea>
                                                        </div>   
                                                    </div>
                                            </div>
                                        </div>
                                  ...
                                  {if $products}
                                      ...
                                      <tr {if $product->checked == 0 } class="not-active" {/if}>
                                          ...
                                          <td class="closed_tb three">
                                            <a href="{site_url_multi('product/view/')}{$product->id}{if $product->alias}-{$product->alias}{/if}" target="_blank"> <p>{if $product->title != '' && !is_null($product->title)}{$product->title}{else}{$defaultname}{/if}</p></a>
                                          </td>
                                          ...
                                          <td class="closed_tb ten">
                                            <center>
                                              <div class="btn-group" style="width:100px;">
                                                  <button type="button" class="btn btn-success btn-bix" data-toggle="tooltip" data-placement="top" title="Copy" onclick="window.location='{base_url("product/copy/")}{$product->id}'"> <i class="fa fa-copy"></i> </button>
                                                  <button type="button" class="btn btn-info btn-bix" data-toggle="tooltip" data-placement="top" title="Edit" onclick="window.location='{base_url("product/update/")}{$product->id}'"> <i class="fa fa-pencil"></i> </button>
                                                  <button type="button" class="btn btn-danger btn-bix remove-trash" data-toggle="tooltip" data-placement="top" title="Delete" onclick="if(confirm('Are you sure?')) window.location='{base_url("product/delete/")}{$product->id}'"> <i class="fa fa-trash"></i> </button>
                                              </div>
                                            </center>
                                          </td>
                                      </tr>
