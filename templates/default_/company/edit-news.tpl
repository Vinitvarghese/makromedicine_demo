    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="n_right_section start_with_text news_page">
                ...
                <div class="upload_img full_width img_fit">
                    <div id="my-file2-preview" style="background-image: url({base_url('uploads/news/')}{$news.image2});"></div>
                    <div class="input-file-container">  
                        <input class="input-file" id="my-file2" name="news_image2" type="file">
                        <label tabindex="0" for="my-file2" class="input-file-trigger">Add Photo</label>
                    </div>
                </div><!-- /.upload_img -->
                
                <label class="text_label">Text Block 2</label>
                
                <textarea class="big_area" name="description2">{$news.description2}</textarea>
