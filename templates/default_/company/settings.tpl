                ...
                <div class="n_right_section start_with_text">
                    ...
                    <div class="full_width max-arrange">
                        <div class="with_buttons full_width m20s">
                            ...
                            <a href="{site_url_multi('/')}pages/{$UserData->slug}" style="width: 150px;" target="_blank">Page</a>
                            <a href="{site_url_multi('/')}companies/{$UserData->slug}" style="width: 150px;" target="_blank">Public Page</a>
                        </div><!-- /.personal_info -->
...
{* 
                            ...
                            <div class="full_width sel_item_adj step4 steps">
                                <div class="comon_h3">
                                    <h3>Products</h3>
                                    <a href="{base_url('/product')}" class="add-product" id="save-and-add-product">Add Product</a>
                                </div>
                            </div><!-- /.sel_item_adj -->
