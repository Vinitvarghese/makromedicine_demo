            ...
            <div class="row">
                ...
                <div class="n_right_section start_with_text decrease_padding interest-page news_page">
                    ...
                    <div class="full_width">
                        <div class="row">
                            <form class="userSettings" action="{base_url('pages')}/{$UserData->slug}/interests" enctype="multipart/form-data" method="post">
...
<script type="text/javascript">
    function addInterest(count) {
      var companent = `<div class="form-group label_`+count+`">
        ...
        <div class="col-md-2 no-padding">
          <label>Standard</label>
          <select class="form-control mylos selectpicker show-menu-arrow pils"  multiple data-actions-box="true" data-live-search="true" data-selected-text-format="count > 1" name="standart[`+count+`][]" title="Standard">
