            ...
            <div class="userSettings">
                ...
                <a href="#" id="menu_hide">Hide</a>
                    <div class="n_profile_img img_fit">
                        <img src="{$user_images}" alt="{$publicprofile->fullname}" id="n_profile_img_uploaded" />
                    </div><!-- /.n_profile_img -->
                    <h2>
                ...
                <div class="n_right_section start_with_text">
                    ...
                    <div class="full_width max-arrange">
                        <div class="drt_form full_width">
                            <div class="full_width">
                                ...
                                {if !empty($publicprofile->company_name)}
                                    <div class="snd_col">
                                        <label>Company <span>{$publicprofile->company_name}</span></label>
                                    </div>
                                    <!-- /.snd_col -->
                                {/if}
                            </div><!-- /.full_width -->
                            <div class="full_width">
                                ...
                                {/if}
                                <div class="snd_col">
                                    {if !empty($publicprofile->brith_day) }
                                        <label>Date of Birth
                                            <span>{$publicprofile->brith_day}
                                                <div class="drop_cstm" style="right: -25px">
                                                    <button disabled type="button" id="setVal" class="setVal">
                                                        <img
                                                                {if $publicprofile->display_dob == 1}
                        ...
                        <div class="n_contact_info full_width">
                            <h3>CONTACT INFO</h3>
                            <div class="drt_form full_width">
                                {if !empty($publicprofile->phone)}
                                    <div class="full_width">
                                        <label>Phone Number
                                            <span>{$publicprofile->phone}
                            				<div class="drop_cstm" style="right: -25px;">
                                                <button disabled type="button" id="phonesetVal" class="setVal">
                                                    <img
                                                            {if $publicprofile->display_phone == 1}
                                                            src="{base_url('templates/default/assets/images/icons/earth_.png')}"
                                                            alt="Public"
                                                            {else}
                                                            src="{base_url('templates/default/assets/images/icons/lock_.png')}"
                                ...
                                {if !empty($publicprofile->email)}
                                    <div class="full_width">
                                        <label>E-mail
                                            <span>{$publicprofile->email}
                            				<div class="drop_cstm"style="right: -25px;">
                                                <button disabled type="button" id="emailsetVal" class="setVal">
                                                    <img
                                                            {if $publicprofile->display_email == 1}
                                                                src="{base_url('templates/default/assets/images/icons/earth_.png')}"
                                                                alt="Public"
                                                                {else}
                                                                src="{base_url('templates/default/assets/images/icons/lock_.png')}"
                                ...
                                <div class="full_width">
                                    <label>City, Country <span>{get_country_name($publicprofile->country_id)}</span></label>
                                </div><!-- /.full_width -->
                            ...
                            <div class="full_width map__" id="maps">
                                {* <img src="{base_url('templates/default/assets/images/map__.png')}" class="pull-left"/> *}
                            </div><!-- map__-->
