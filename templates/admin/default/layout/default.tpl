{include file="templates/admin/default/_partial/header.tpl"}
{include file="templates/admin/default/_partial/navbar.tpl"}
	...
	<!-- /page container -->
{include file="templates/admin/default/_partial/footer.tpl"}