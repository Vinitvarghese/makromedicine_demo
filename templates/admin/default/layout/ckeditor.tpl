...
<script type="text/javascript" src="{$admin_theme}/global_assets/js/plugins/editors/ckeditor/ckeditor.js"></script>
...
<script type="text/javascript" src="{$admin_theme}/global_assets/js/plugins/ui/prism.min.js"></script>
<script type="text/javascript" src="{$admin_theme}/global_assets/js/plugins/forms/inputs/typeahead/typeahead.bundle.min.js"></script>
...
<!-- Common JS files -->
<script type="text/javascript" src="{$admin_theme}/assets/js/common.js?v=2"></script>
<!-- /common JS files -->
