$(function() {
    ...
    $( 'textarea.editor').each( function() {
        ...
        CKEDITOR.replace('editor'+id, {
            height: '300px',
            filebrowserBrowseUrl: '/en/admin/filemanager/index/ckeditor'
        });
        id = id + 1;
    });
    ...
    // Status change
    $(document).on('click', 'input.changeStatus', function(e) {
    ...
    $(document).on('click', 'button#deleteSelectedItems', function(e) {
      ...
      $(document).on('click', 'button#activateItems', function(e) {
        let url = $(this).data('href');
        let selected_items = $('form#form-list').serializeArray();
        
        if(selected_items){
            swal({
                title: "Do you want to activate all selected items?",
                type: "success",
                showCancelButton: true,
                closeOnConfirm: false,
                confirmButtonColor: "#4CAF50",
