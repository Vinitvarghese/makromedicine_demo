           ...
           {* {if  $user['group_id'] eq 2 ||  $user['group_id'] eq 3 ||  $user['group_id'] eq 4}
            ...
            <div class="row">
                ...
                <div class="n_right_section start_with_text">
                    ...
                    <div class="full_width pr-s-n comon_h3">
                        <h3>COMPANY NAME CHANGE NOTIFICATIONS</h3>
                    </div><!-- /.with_buttons -->

                    <form class="userSettings userSettingsFlex" action="{base_url()}profile/notifications" enctype="multipart/form-data"
                          method="post">
                        <div class="n_checkbox full_width mbm38">
                            <div class="check_con full_width">
                                ...
                                <input type="checkbox" name="ntf_comp_email" id="forget-me-change-mail" value="1"
                                       {if isset($account_settings['ntf_comp_email']) && $account_settings['ntf_comp_email'] eq 1}checked="checked"{/if} />
                            ...
                            <div class="check_con full_width">
                                ...
                                <input type="checkbox" name="ntf_comp_sms" id="forget-me-change-sms" value="1"
                                       {if isset($account_settings['ntf_comp_sms']) && $account_settings['ntf_comp_sms'] eq 1}checked="checked"{/if} />
                        ...
                        <div class="full_width pr-s-n comon_h3">
                            <h3>CERTIFICATE CONFIRM NOTIFICATIONS</h3>
                        </div><!-- /.with_buttons -->
                        ...
                        <div class="n_checkbox full_width mbm38">
                            <div class="check_con full_width">
                                ...
                                <input type="checkbox" name="ntf_cert_email" id="forget-me-noty-mail" value="1"
                                       {if isset($account_settings['ntf_cert_email']) && $account_settings['ntf_cert_email'] eq 1}checked="checked"{/if} />
                            ...
                            <div class="check_con full_width">
                                ...
                                <input type="checkbox" name="ntf_cert_sms" id="forget-me-noty-sms" value="1"
                                       {if isset($account_settings['ntf_cert_sms']) && $account_settings['ntf_cert_sms'] eq 1}checked="checked"{/if} />
                        ...
                        <div class="n_checkbox full_width mbm38">
                            <div class="check_con full_width">
                                ...
                                <input type="checkbox" name="ntf_pass_email" id="forget-me-pass-mail" value="1"
                                       {if isset($account_settings['ntf_pass_email']) && $account_settings['ntf_pass_email'] eq 1}checked="checked"{/if} />
                            ...
                            <div class="check_con full_width">
                                ...
                                <input type="checkbox" name="ntf_pass_sms" id="forget-me-pass-sms" value="1"
                                       {if isset($account_settings['ntf_pass_sms']) && $account_settings['ntf_pass_sms'] eq 1}checked="checked"{/if} />
                                <label for="forget-me-pass-sms"></label>
                                <label for="forget-me-pass-sms">Get notifications via SMS</label>
                            </div><!-- /.check_con -->
                        </div><!-- /.n_checkbox -->

                        <div class="btn_wrap flex  align_center full_width">
                            <input type="submit" class="n_save" value="Save">
                        </div><!-- /.btn2_ -->
                    </form>
