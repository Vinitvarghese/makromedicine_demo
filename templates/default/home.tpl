                        ...
                        <div class="tab-content">
                          <div role="tabpanel" class="tab-pane active" id="product">
                           ...
                           <select name="pr_type[]" class="selectpicker show-menu-arrow main_product_type" multiple data-live-search="true" data-actions-box="true" data-selected-text-format="count > 0" title="Product Type">
                              <option value="all" class="hidden" >Select all</option>   
                           ...
                           <select name="company_ids[]" class="selectpicker show-menu-arrow main_company_name" multiple data-live-search="true" data-actions-box="true" data-selected-text-format="count > 0" title="Company Name">
                              <option value="all" class="hidden">Select all</option>
                          ...
                          <div role="tabpanel" class="tab-pane" id="event">
                            <select name="event_type[]" multiple class="selectpicker show-menu-arrow main_event_type"
                                data-live-search="true" data-actions-box="true" data-selected-text-format="count > 0" title="Event Type">
                              <option value="all" class="hidden">Select all</option>
                          ...
                          <div role="tabpanel" class="tab-pane" id="tender">
                            <select name="trade_type" class="selectpicker show-menu-arrow main_event_type" data-selected-text-format="count > 0" title="Trade Terms">
                              ...
                              {if $delivery_type}{foreach from=$delivery_type item=del_item}
                              <option value="{$del_item->id}">{$del_item->method_abbr}</option>
                              {/foreach}{/if}
                           </select>
                           ...
                           <select name="dossage_type[]" multiple class="selectpicker show-menu-arrow main_event_type"
                               data-selected-text-format="count > 0" data-live-search="true" data-actions-box="true" title="Dossage Forms">
                           <option value="all" class="hidden">Select all</option>   
                           {if $dossageforms}{foreach from=$dossageforms item=dos_item}
                              <option value="{$dos_item->id}">{$dos_item->name}</option>
                              {/foreach}{/if}
                           </select>
                          ...
                          <div role="tabpanel" class="tab-pane" id="company">
                           {*<select name="event_country[]" class="selectpicker show-menu-arrow main_company_country" multiple data-live-search="true" data-actions-box="true" data-selected-text-format="count > 0" title="Country">
                              {if $countrys}{foreach from=$countrys item=country}
                              <option value="{$country->id}" {if in_array($country->id, $event_country)} selected="selected" {/if}>{$country->name}</option>
                              {/foreach}{/if}
                           </select>*}
          ...
          <div class="row">
             <div class="col-md-12 main-flex">
                ...
                <div class="service-box col-md-3 col-sm-6 col-xs-6">
                    <a {if $is_loggedin} href="{site_url_multi('search/groups/')}{$country_code}/2" {else}href="#" class="triggerSignup"{/if}>
                ...
                <div class="service-box col-md-3 col-sm-6 col-xs-6">
                    <a {if $is_loggedin} href="{site_url_multi('search/groups/')}{$country_code}/3" {else}href="#" class="triggerSignup"{/if}>
                        <div class="service-box-img">
                ...
                <div class="service-box col-md-3 col-sm-6 col-xs-6">
                    <a {if $is_loggedin} href="{site_url_multi('search/groups/')}{$country_code}/4" {else}href="#" class="triggerSignup"{/if}>
                      <div class="service-box-img">
                ...
                <div class="service-box col-md-3 col-sm-6 col-xs-6">
                    <a {if $is_loggedin} href="{site_url_multi('search/groups/')}{$country_code}/5" {else}href="#" class="triggerSignup"{/if}>
                      <div class="service-box-img">
             ...
             <div class="col-md-12" id="country">
                ...
                <div class="col-md-12 no-padding country-flag">
                   ...
                   {foreach from=$countrys item=country}
                       {if isset($countries_count[$country->id])}
