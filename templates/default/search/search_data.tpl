                      ...
                      <table class="table responsive table-striped no-padding display table-search-not"  id="example" >
                          <thead>
                              <tr>
                                  <th class="one"></th>
                                  <th class="two">
                                    <select class="form-control selectpicker show-menu-arrow product_type" multiple data-live-search="true" data-selected-text-format="count > 0" data-actions-box="true" title="Product Type">
                                        <option value="all" class="hidden" {if in_array('all', $pr_type)} selected {/if}>Select all</option>
                                    </select>
