                                    ...
                                    <form class="" action="" method="post">
                                      <div class="col-md-6 no-padding">
                                            <div class="form-group">
                                                <input type="text" minlength="3" class="form-control" name="fullname" required placeholder="{translate('form_placeholder_fullname')}">
                                            </div>
                                            <div class="form-group">
                                                <input type="tel" class="form-control numeric" name="phone"  placeholder="{translate('form_placeholder_phone')}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 no-padding-right">
                                            <div class="form-group">
                                                <input type="email" class="form-control" name="email" required placeholder="{translate('form_placeholder_email')}">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="subject"  placeholder="{translate('form_placeholder_subject')}">
                                            </div>
                                        </div>
                                      
                                        <div class="col-md-12 no-padding">
                                            <div class="form-group">
                                                <textarea name="message" class="form-control" rows="20" minlength="3" required></textarea>
                                            </div>
