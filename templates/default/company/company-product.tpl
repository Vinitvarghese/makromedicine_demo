                                    ...
                                    {if $products}
                                        {foreach from=$products item=product}
                                            ...
                                            {if count($atc_code) > 0 || count($herbal) > 0 || count($animals) > 0 || count($casNumbers) > 0}
                                                {if isset($company->company_name)}
                                                    ...
                                                    <tr class=" {if $product->checked==0} approve_waiting {/if} " valign="middle" >
                                        ...
                                        <span>
                                          ...
                                          {/foreach} {else} {/if}
                                                            ...
                                                            <td class="product_manage_btn operation_column">

                                                                <div class="flex align_center justify_end operation_btns">
                                                                    {if $permission_list[4]->view == 1}
                                                                        <a
                                                                            href="{site_url_multi('product/')}{$UserData->slug}/view/{$product->id}">
                                                                            <svg width="23" height="23" viewBox="0 0 23 23"
                                                                                ...
                                                                                <path fill-rule="evenodd"
                                                                                    clip-rule="evenodd"
                                                                                    d="M12.903 18.7841H9.69995V8.47412H12.903V18.7841Z"
                                                                                    fill="white" />
                                                                                <path fill-rule="evenodd"
                                                                                    clip-rule="evenodd"
