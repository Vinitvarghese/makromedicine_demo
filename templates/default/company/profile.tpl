                                        ...
                                        <label>
                                            ...
                                            <span>
                                                {foreach $groups as $k => $v}
                                                    {if  $user['group_id']==$v->id}{$v->name}{/if}
                                                {/foreach}
                                            </span>
                                        </label>
                                    </div><!-- /.fst_col -->
                                    ...
                                    <div class="full_width">
                                        {if !empty($UserData->company_address)}
                                            <div class="fst_col">
                                                ...
                                                <div class="map__">
                                                    <iframe width="265" height="150"  src="https://maps.google.com/maps?q={$UserData->company_address}&t=&z=13&ie=UTF8&iwloc=&output=embed" allowfullscreen frameborder="0" scrolling="no" marginheight="0" marginwidth="0" ></iframe>
