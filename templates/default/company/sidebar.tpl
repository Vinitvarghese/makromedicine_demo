...
<div class="userSettings">
    ...
    <a href="#" id="menu_hide">Hide </a>
        ...
        {if $get_confirm_status eq false}
                ...
                <!-- /.ad_pro -->
        {elseif $get_confirm_status->status==0  }
            <span class="verify_acc full_width">Your Account verification waiting<i>!</i></span>
            <div class="ad_pro_n full_width mb_30">
                <a href="#" class="red_verify yellow_verify" id="verify_account_modal">View detail</a>
            </div>
        ...
        <div class="n_profile_img img_fit">
            ...
            {if isset($get_confirm_status) && !empty($get_confirm_status)}
                {if $get_confirm_status->status == 1}
                    <a href="javascript:" data-title="Your account verified" class="n_pro_tick account_verified">
                    <img
        ...
        {foreach $groups as $k => $v}
            {if  $user['group_id']==$v->id}<p class="company_status_txt">{$v->name}</p>{/if}
        {/foreach}
        ...
        <div class="rate_only {if $company_star_rate_count >= 1} rated {else} not_rated {/if}">

            <button type="button" class="rating_start  give_rating_btn_1 {if $company_star_rate_count >= 1 } active {/if}  give_rating_btn "  >
                <svg  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" ><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z" class=""></path></svg>
            </button>

            <button type="button" class="rating_start give_rating_btn_2 {if $company_star_rate_count >= 2 } active {/if}  give_rating_btn"   >
                <svg  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" ><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z" class=""></path></svg>
            </button>

            <button type="button" class="rating_start give_rating_btn_3 {if $company_star_rate_count >= 3 } active {/if} give_rating_btn "   >
                <svg  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" ><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z" class=""></path></svg>
            </button>

            <button type="button" class="rating_start give_rating_btn_4 {if $company_star_rate_count >= 4 } active {/if} give_rating_btn "   >
                <svg  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" ><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z" class=""></path></svg>
            </button>

            <button type="button" class="rating_start give_rating_btn_5 {if $company_star_rate_count >= 5 } active {/if}  give_rating_btn "  >
                <svg  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" ><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z" class=""></path></svg>
            </button>
        ...
        <ul class="full-width follow_li flex justify_between">
            <li {if isset($active_menu) and $active_menu == "followers"} class="active" {/if}>
                ...
                <a href="{site_url_multi('/')}pages/{$UserData->slug}/followers?type=2" >
            ...
            <li {if isset($active_menu) and $active_menu == "following"} class="active" {/if}>
                <a href="{site_url_multi('/')}pages/{$UserData->slug}/following?type=2">
    ...
    <div class="n_navigation">
        ...
        <ul class="create_company_and_look_page not_hover">
            <li><a target="_blank" class="see_my_page" {if isset($active_menu) and $active_menu == 9} class="active" {/if}
                   href="{site_url_multi('/')}companies/{$UserData->slug}"> <span>See how my page looks</span></a>
            </li>
        </ul>
        ...
        <ul>
            ...
            {if  $permission_list[5]->view == 1}
                <li><a {if isset($active_menu) and $active_menu == 5} class="active" {/if} href="javascript:"><img
                                src="{base_url('templates/default/assets/images/icons/tender.png')}"/><span>Tender</span></a>
                </li>
            {/if}

            {if $permission_list[6]->view == 1}
                <li><a {if isset($active_menu) and $active_menu == 6} class="active" {/if} href="javascript:"><img
                    ...
                    <div class="modal-content">
                        <form class="comfirmAccount" enctype="multipart/form-data" action="{base_url()}profile/comfirmAccount"  method="post">
                            ...
                            <div class="modal-body data-response confirm_account_body">
                                ...
                                <p>Enter the required documents to confirm the authenticity of the company. Your account will be verified after confirmation by moderators.</p>

                                <div class="mod_center_inp change_pss">

                                    <div class="form-group upload_file_box" >
                                        <div class="upload_file_btn" >
                                            <input type="file" name="certifcate" required class="choose_certifcate"
                                                {if !empty($get_confirm_status) && $get_confirm_status->status==0} disabled {/if}  />
                                            ...
                                            <a href="{if !empty($get_confirm_status) && $get_confirm_status->status==0}{base_url('uploads/catalog/certifcate/')}{$get_confirm_status->image}{/if}"
                                                {if !empty($get_confirm_status) && $get_confirm_status->status==0} target="_blank" {/if}
                                                class="show_certificate
                                                {if !empty($get_confirm_status) && $get_confirm_status->status==0}
                                                active {/if}">{if !empty($get_confirm_status) && $get_confirm_status->status==0}{$get_confirm_status->image}{/if}</a>
                                        </div>
        <textarea name="info" class="form-control " {if !empty($get_confirm_status) && $get_confirm_status->status==0} disabled {/if} required
            placeholder="You can write something…"
            minlength="10">{if !empty($get_confirm_status) && $get_confirm_status->status==0}{$get_confirm_status->info}{/if}</textarea>
                                    </div>
                                </div>
                                <div class="mod_center_inp_textarea">
                                    {if $get_confirm_status eq false}
                                        <button type="button" class="close close_modal_btn"
                                            data-dismiss="modal">Cancel</button>
                                        <button type="submit" class="yes_modal_btn">Save</button>
                                    {elseif !empty($get_confirm_status) && $get_confirm_status->status==0}
                                        <button type="button" class="close close_modal_btn"
