                ...
                <div class="full_width news_tiles">
                    ...
                    <div class="n_pagination full_width">
                        ...
                        {if $prev_page < $num_pages && $prev_page > 0 }
                            <a href="{site_url_multi('/')}pages/{$UserData->slug}/news?page={$prev_page}" class="prev"><img src="{base_url('templates/default/assets/images/icons/page_prev.png')}"></a>
                        {/if}
                        {for $page_item=1 to $num_pages}
                            <a class=" {if $curr_page==$page_item } active {/if} " href="{site_url_multi('/')}pages/{$UserData->slug}/news?page={$page_item}">{$page_item}</a>
                        {/for}
                        {if $next_page <= $num_pages }
                            <a href="{site_url_multi('/')}pages/{$UserData->slug}/news?page={$next_page}" class="next"><img src="{base_url('templates/default/assets/images/icons/page_next.png')}"></a>
                        {/if}
