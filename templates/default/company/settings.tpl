...
{block name=content}
        ...
        <div class="container-fluid">
            <div class="all_modals full_width">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="changePassword" action="{base_url()}profile/changePassword" method="post">
                                    ...
                                    <div class="mod_center_inp change_pss">
                                        ...
                                        {* <a href="#" class="fr_pass" onclick="$('#forGot').modal();">Forgot your password?</a> *}
                                    </div><!-- /.mod_center_inp -->
                ...
                {if  $user['group_id'] eq 2 ||  $user['group_id'] eq 3 ||  $user['group_id'] eq 4}
                    <div id="comfirmAccount" class="modal fade" role="dialog" >
            ...
            <div class="row">
                ...
                <div class="n_right_section start_with_text">
                                ...
                                {foreach $percentage_list as $k => $v}
                                    <li>
                                        <div class=" user_i_top">
                                            <img src="{base_url()}templates/default/assets/images/icons/redd.png"/>
                                            <span>{$v['title']}</span>
                    ...
                    <div class="full_width max-arrange">
                        ...
                        <form class="userSettings userSettingsCenter steps_form" action="{base_url()}profile/save" enctype="multipart/form-data" method="post">
                            ...
                            <div class="n_like_form full_width step1 steps">
                                <div class="n_first_block">
                                    ...
                                    <div class="full_width" style="position: relative">
                                        <label>Company Name <sup>*</sup></label>
                                            ...
                                            <input type="text" name="company_name" id="company-name"
                                                   class="readonly company_name" placeholder="" value="" required minlength="3">


                                    </div><!-- /.full_width -->

                                    <div class="full_width position_div position_div_apply hidden"    >
                                    ...
                                    <div class="full_width sel_full">
                                        ...
                                        <select name="group_id" class="n_select" required>
                                    ...
                                    <div class="full_width sel_full">
                                        ...
                                        <select class="selectpicker"
                                                ...
                                                data-selected-text-format="count > 1" title="Field of activity" required>
                                    ...
                                    <div class="full_width date_of_brth flex direction_column">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="hidden" class="bith_day_input" name="establishment_date" value="" />
                                            ...
                                            <input type="text" name=""
                                                   ...
                                                   value="" required placeholder="Day">

                                            <select class="form_input month_input append_value_onchange"
                                                data-group="day_input,month_input,year_input"
                                                data-target="bith_day_input" data-glue="-" required>
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="" required placeholder="Year">
                            ...
                            <div class="n_like_form full_width step2 steps">
                                ...
                                <div class="upload_img_area">
                                    ...
                                    <div class="add_logo_n" id="company_logo_wrapper" data-image="">
                                ...
                                <div class="upload_img_area">
                                    ...
                                    <div class="add_cover_n" id="company_cover_wrapper" data-image="">
                                ...
                                <div class="full_width text_stl">
                                    ...
                                    <textarea name="company_info" id="company-info"></textarea>
                                </div><!-- /.full_width -->
                            </div><!-- /.n_like_form -->
                                    ...
                                    {if $company_info}{foreach $company_info as $secret=>$company}
                                        <div class="form-group clone_line"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group full_width copiered_company">
                                                ...
                                                <div class="form-group full_width copiered_company">
                                                    ...
                                                    <div class="flex direction_column">
                                                        ...
                                                        <div class="flex">
                                                            ...
                                                            <input type="tel" name="company[phone][]"
                                                                   class="   inputmask phone phone_input2"
                            ...
                            {*<div class="full_width sel_item_adj step4 steps">
                                <div class="comon_h3">
                                    <h3>Products</h3>
                                    <a href="{base_url('/product')}" target="_blank" class="add-product" id="save-and-add-product">Add Product</a>
                                </div>
                            </div>*}
                            <!-- /.sel_item_adj -->

                            <div class="btn_wrap full_width ">
                                <div class="btn_wrap hasfull full_width flex justify_center">
                                    <a href="#" id="company_next"  style="display: none;" class="n_cancel">Previous Step</a>
                                    <a href="#" id="company_prev" class="n_save">Next Step</a>
                                    <input id="submit_btn" type="submit" class="n_save" disabled value="Submit" >
                                </div><!-- /.btn_wrap -->
                            </div><!-- /.btn_wrap -->
                        </form>
                    </div><!-- /.max_arrange -->
    ...
    <div class="">
        <div class="container">
                            ...
                            <form class="addCompanyInformation" action="{base_url()}profile/companyInformation"
                                ...
                                <div class="modal-body data-body"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="page" name="page_item">
                                    </div>
                                    <div class="form-group ">
            ...
            {/if}
            {/if}*}
            <div id="changeCompanyName" class="modal fade" role="dialog" >
                <div class="modal-dialog">
                    <div class="modal-content">
    ...
    <script type="text/javascript">
        function addPhone(count, target) {
            ...
            <div class="col-md-4">
                ...
                <div class="form-group full_width copiered_` + target + `">
            ...
            <div class="col-md-4 no-padding">
                <div class="form-group">
                    <label for="company-status" class="round"> Email <sup>*</sup></label>
                    <input type="email" name="` + target + `[email][` + count + `]" id="company-status" class="form-control mylos" >
                </div>
                <div class="form-group">
                    <label for="company-ext" class="fill"> Type </label>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <div class="form-group has-suggestion">
                        ...
                        <select required class="selectpicker form-control show-menu-arrow mylos mb-20" name="` + target + `[person_type][` + count + `]" data-live-search="true" data-selected-text-format="count > 1" title="Person Type">
                            {if $person_type}{foreach $person_type as $key => $value}
                            <option value="{$value->id}">{$value->name}</option>SS
                            {/foreach}{/if}
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label for="company-ext" class="fill"> Ext </label>
                    <input type="text" name="` + target + `[ext][` + count + `]"  class="form-control mylos">
