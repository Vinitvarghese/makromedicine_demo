                      ...
                      <table class="table table-striped no-padding table-search-not">
                          <thead>
                              <tr>
                                  ...
                                  <th class="three">
                                    <input type="text" name="brand_name" class="form-control brand_name" value="{$keyword}" placeholder="Brand Name">
                                  </th>
                                  <th class="four">
                                    <select name="content[]" class="form-control selectpicker show-menu-arrow select_content" multiple data-live-search="true" data-actions-box="true" data-selected-text-format="count > 0" title="Content">
                                  ...
                                  <th class="six">
                                    ...
                                    <option value="{$countryd->id}" {if in_array($countryd->id,$search_country)} selected="selected" {/if}>{$countryd->name}</option>
                                    {/foreach}{/if}
                                    </select>
                                  </th>
                                  <th class="seven">
                                    <select name="medical[]" class="form-control selectpicker show-menu-arrow select_medical" multiple data-live-search="true" data-actions-box="true" multiple data-selected-text-format="count > 0" title="Medical Classification">
                                  ...
                                  <th class="eight">
                                    <select name="company[]" class="form-control selectpicker show-menu-arrow select_company" multiple data-live-search="true" data-actions-box="true" data-selected-text-format="count > 0" title="Manufacturer">
                                  ...
                                  <th class="nine" style="padding:8px;"><a href="#">Actions </a></th>
                                  <th class="ten" style="padding:8px;"><a href="#">Operations</a></th>
                              </tr>
                          </thead>
                          <tbody>
                              {if $products}
