                ...
                <div class="n_right_section decrease_padding_20 start_with_text">
                    <div class="banner_image_n img_fit full_width ">
                        {if $UserData->company_banner}
                            <img src="{site_url()}uploads/catalog/users/{str_replace([site_url(), 'uploads/catalog/users/'], ['', ''], $UserData->company_banner)}" style="max-height: 220px; object-fit: cover;" alt="img"/>
                        {else}
                    ...
                    <div class="full_width need_padding_here">
                        <div class="cmother full_width pr-s-n with_buttons">
                            ...
                            {if $permission_list[8]->edit == 1}
                                <a href="{site_url_multi('/')}profile/pages/{$UserData->slug}/edit-page">Edit Info</a>
                            {/if}
                        </div>
                        <div class="full_width max-arrange">
                            <div class="drt_form full_width">
                                <div class="full_width">
                                    <div class="fst_col">
                                        <label>
                                            Company Name <span>{$UserData->company_name}</span> <br/>
                                            Status
                                            <span>
                                                {if $user['group_id'] eq 2}
                                                    Manufacturer
                                                {elseif $user['group_id'] eq 3}
                                                    Distributor
                                                {elseif $user['group_id'] eq 4}
                                                    Agent
                                                {elseif $user['group_id'] eq 5}
                                                    Manager
                                                {elseif $user['group_id'] eq 6}
                                                    User
                                                {/if}
                                            </span>
                                        </label>
                                ...
                                <div class="full_width">
                                    ...
                                    {if !empty($UserData->website)}
                                        <div class="snd_col">
                                            <label>Website <span><a href="{$UserData->website}" target="_blank" class="underlined">{$UserData->website}</a></span></label>
                                        </div>
                                        <!-- /.snd_col -->
                                    {/if}
                                </div><!-- /.full_width -->
                                ...
                                <div class="drt_form full_width">
                                    ...
                                    <div class="full_width">
                                        {if !empty($UserData->company_address)}
                                            <div class="fst_col">
                                                <label>Address <span>{$UserData->company_address}</span></label>
                                                <div class="map__">
                                                    <iframe width="265" height="265"  src="https://maps.google.com/maps?q={$UserData->company_address}&t=&z=13&ie=UTF8&iwloc=&output=embed" allowfullscreen frameborder="0" scrolling="no" marginheight="0" marginwidth="0" ></iframe>
