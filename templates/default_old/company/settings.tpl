                        ...
                        <form class="userSettings userSettingsCenter steps_form" action="{base_url()}profile/save" enctype="multipart/form-data" method="post">
                                ...
                                <div class="n_first_block">
                                    <div class="full_width" style="position: relative">
                                        <label>Company Name <sup>*</sup></label>
                                            ...
                                            <input type="text" name="company_name" id="company-name"
                                                   class="readonly" placeholder="" value="" required minlength="3">
                                    ...
                                    <div class="full_width date_of_brth">
                                        ...
                                        <input type="text" name="establishment_date" id="company-date"
                                               class="" placeholder="Establishment date" required
                                               value="">
                                    </div><!-- /.full_width -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group copiered_company">
                                                    ...
                                                    <input type="hidden" name="company[code][][]"
                                                           class="dial-up"
                                                           value="{if empty($company->code)}{$UserData->country_code}{else}{$company->code}{/if}">
                                                    <input type="tel" name="company[phone][][]" id="phone"
                                                           class="form-control inputmask mylos phones "
                                                           value="{$company->phone}"
                            ...
                            <div class="btn_wrap full_width">
                                <div class="btn_wrap hasfull full_width">
                                    <a href="#" id="company_next"  style="display: none;" class="n_cancel">Previous</a>
