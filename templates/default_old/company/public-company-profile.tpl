                    ...
                    <div class="full_width max-arrange">
                        <div class="drt_form full_width">
                            <div class="full_width">
                                <div class="fst_col">
                                    <label>
                                        Company Name <span>{$user->company_name}</span> <br/>
                                    </label>
                                </div><!-- /.fst_col -->
                                <div class="snd_col">
                            ...
                            <div class="full_width">
                                ...
                                {if !empty($user->website)}
                                    <div class="snd_col">
                                        <label>Website <span><a href="{$user->website}" target="_blank" class="underlined">{$user->website}</a></span></label>
                                    </div><!-- /.snd_col -->
                                {/if}
                        ...
                        <div class="n_contact_info full_width">
                            ...
                            {if $company_info}{foreach $company_info as $company}
                                <div class="drt_form full_width">
                                            ...
                                            <label>Person Type
                                                {if $person_type}
                                                    {foreach $person_type as $key => $value}
                                                        {if $value->id == $company->person_type } <span class="get_underline">{$value->name} </span>{break} {/if}
                                                    {/foreach}
                                                {/if}
                                            </span></label>
                                        </div><!-- /.snd_col -->
                                    ...
                                    <div class="full_width">
                                        <div class="fst_col">
                                            <label>Country <span>{get_country_name($user->country_id)}</span></label>
                                        </div><!-- /.fst_col -->
                                        <div class="snd_col">
                                    ...
                                    <div class="full_width">
                                        {if !empty($user->company_address)}
                                            <div class="fst_col">
                                                <label>Address <span>{$user->company_address}</span></label>
                                                <div class="map__">
                                                    <iframe width="265" height="265"  src="https://maps.google.com/maps?q={$user->company_address}&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
