            ...
            <div class="col-md-12">
                <form class="searchTable" action="{base_url('home/search_table')}" method="post">
                  <div class="col-md-12 no-padding tables-data">
                      <div class="col-md-12">
                        <h2 style="padding-left:30px;">{$company->company_name} company products</h2>
                      </div>
                              ...
                              {if $products}
                                  ...
                                  <tr>
                                      ...
                                      <td class="closed_tb nine">
                                          <center>
                                              <a type="button" class="btn btn-info btn-circle btn-lg" data-target="{$product->id}"  href="{site_url_multi('product/view/')}{$product->id}"><i class="fa fa-info"></i></a>
                                         </center>
                                      </td>
